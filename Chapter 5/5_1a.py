...
In Python, a list literal is written as a sequence of data 
...
# You can also use the other lists as elements in a list,
# thereby creating a list of lists

[[5, 9], [541, 78]]

myList = [1, "abc", 4.0, True]
print(myList)
